...
!(function (e, t) {
    ...
    if (a.enabled) {
      ...
      if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
        if (!i.isTouchEvent || 'touchmove' === o.type) {
          ...
          if (!a.allowTouchMove)
            return (a.allowClick = !1), void (i.isTouched && (M(n, { startX: p, startY: u, currentX: p, currentY: u }), (i.touchStartTime = x())));
  ...
  function B(e) {
    ...
    if (t.enabled) {
      ...
      if (
        (t.allowClick &&
          (t.updateClickedSlide(d), t.emit('tap click', d), c < 300 && u - a.lastClickTime < 300 && t.emit('doubleTap doubleClick', d)),
        (a.lastClickTime = x()),
        E(function () {
          ...
          i.loop && 0 === d.length && (d = a.eq(-1)).addClass(i.slidePrevClass),
            i.loop &&
              (o.hasClass(i.slideDuplicateClass)
                ? s
                    .children(
                      '.' + i.slideClass + ':not(.' + i.slideDuplicateClass + ')[data-swiper-slide-index="' + o.attr('data-swiper-slide-index') + '"]'
                    )
        ...
        (l.__swiper__ = !0),
          ...
          Object.keys(l.modules).forEach(function (e) {
            ...
            if (t.params) {
              ...
              if ((['navigation', 'pagination', 'scrollbar'].indexOf(i) >= 0 && !0 === a[i] && (a[i] = { auto: !0 }), !(i in a) || !('enabled' in s)))
                return;
              !0 === a[i] && (a[i] = { enabled: !0 }),
  ...
  var J = {
    ...
    ee = {
      update: function () {
        ...
        if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          if (
            ('fraction' === a.type &&
              (r.find(P(a.currentClass)).text(a.formatFractionCurrent(i + 1)), r.find(P(a.totalClass)).text(a.formatFractionTotal(n))),
            'progressbar' === a.type)
          ) {
            var E;
    ...
    re = {
      ...
      getInterpolateFunction: function (e) {
        var t = this;
        t.controller.spline ||
          (t.controller.spline = t.params.loop ? new re.LinearSpline(t.slidesGrid, e.slidesGrid) : new re.LinearSpline(t.snapGrid, e.snapGrid));
      },
      setTranslate: function (e, t) {
        var a,
          i,
      ...
      init: function () {
        ...
        return (
          t.swiper instanceof a
            ...
            : C(t.swiper) &&
              ((e.thumbs.swiper = new a(M({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))),
          ...
          if (t.realIndex !== a.realIndex || r) {
            ...
            r && (n += 'next' === l ? s : -1 * s),
              a.visibleSlidesIndexes &&
                ...
                (a.params.centeredSlides ? (n = n > o ? n - Math.floor(i / 2) + 1 : n + Math.floor(i / 2) - 1) : n > o && a.params.slidesPerGroup,
